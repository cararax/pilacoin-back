                    ...
                    "usuariosResult": [
                        ...
                        },
                        {
                            ...
                            "nome": "testeMadrugs"
                                ...
                                """;
        QueryResponse usuarios = mapper.readValue(users, QueryResponse.class);
        usuarioRepository.saveAll(usuarios.getUsuariosResult());
        log.info("Usuários salvos com sucesso!");
    }
